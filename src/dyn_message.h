...
typedef enum msg_type {
    ...
    MSG_RSP_MONGO_OP_REPLY,				/* mongo - response */
    MSG_REQ_MONGO_OP_MSG,
    MSG_REQ_MONGO_OP_UPDATE,
    MSG_REQ_MONGO_OP_INSERT,
    MSG_REQ_MONGO_RESERVED,
    MSG_REQ_MONGO_OP_QUERY,
    MSG_REQ_MONGO_OP_GET_MORE,
    MSG_REQ_MONGO_OP_DELETE,
    MSG_REQ_MONGO_KILL_CURSORS,
    MSG_SENTINEL
} msg_type_t;
